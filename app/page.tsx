export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-8 px-4">
      <h1 className="text-[clamp(1.5rem,6vw,3.75rem)] font-medium text-neutral-900 dark:text-white drop-shadow-[0_2px_12px_rgba(255,255,255,0.9)] dark:drop-shadow-[0_2px_16px_rgba(255,255,255,0.35)]">
